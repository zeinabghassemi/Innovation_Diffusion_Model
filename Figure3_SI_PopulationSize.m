%% Supplementary Figure S3: Population Size Sensitivity Analysis
%
% This script reproduces Supplementary Figure S3.
%
% The analysis examines how total population size influences
% innovation adoption and disparity outcomes.
%
% Two sensitivity analyses are performed:
%
% (1) Population size under different levels of intergroup interaction.
%
% (2) Population size under different technology learning rates.
%
% Outputs:
...
b = 0.2;
a = 0;
E = 0.15; % the experience parameter E for solar panels
rho0 = 30; 
n0 = 8000;
t_initial = 0;
t_final = 500;
...
nexttile;
hold on;
plot(i_values * 8000, disparity_h1, 'r', 'LineWidth', 3, 'DisplayName', 'I = 0');
plot(i_values * 8000, disparity_h2, 'b--', 'LineWidth', 3, 'DisplayName', 'I = 0.14');
plot(i_values * 8000, disparity_h3, 'g:', 'LineWidth', 4, 'DisplayName', 'I = 0.37');
plot(i_values * 8000, disparity_h4, 'k.-', 'LineWidth', 3, 'DisplayName', 'I = 0.5');
xlabel('Population Size');
xlim([8000 40000]);
ylabel('Equilibrium Disparity');
%title('Disparity vs Size of Population for h');
legend('show');
grid on;
hold off;
...
nexttile;
hold on;
plot(i_values * 8000, z_h1, 'r', 'LineWidth', 3, 'DisplayName', 'I = 0');
plot(i_values * 8000, z_h2, 'b--', 'LineWidth', 3, 'DisplayName', 'I = 0.14');
plot(i_values * 8000, z_h3, 'g:', 'LineWidth', 4, 'DisplayName', 'I = 0.37');
plot(i_values * 8000, z_h4, 'k.-', 'LineWidth', 3, 'DisplayName', 'I = 0.5');
xlabel('Population Size');
xlim([8000 40000]);
ylabel('Overall Adoption');
%title('Adoption Proportion vs Size of Population for h');
legend('show');
grid on;
hold off;
...
nexttile;
hold on;
plot(i_values * 8000, disparity_e1, 'r', 'LineWidth', 3, 'DisplayName', 'E = 0.16');
plot(i_values * 8000, disparity_e2, 'b--', 'LineWidth', 3, 'DisplayName', 'E = 0.18');
plot(i_values * 8000, disparity_e3, 'g:', 'LineWidth', 4, 'DisplayName', 'E = 0.2');
xlabel('Population Size');
xlim([8000 40000]);
ylabel('Equilibrium Disparity');
%title('Disparity vs Size of Population for E');
legend('show');
grid on;
hold off;
...
nexttile;
hold on;
plot(i_values * 8000, z_e1, 'r', 'LineWidth', 3, 'DisplayName', 'E = 0.16');
plot(i_values * 8000, z_e2, 'b--', 'LineWidth', 3, 'DisplayName', 'E = 0.18');
plot(i_values * 8000, z_e3, 'g:', 'LineWidth', 4, 'DisplayName', 'E = 0.2');
xlim([8000 40000]);
xlabel('Population Size');
ylabel('Overall Adoption');
%title('Adoption Proportion vs Size of Population for E');
legend('show');
grid on;
hold off;