%% Supplementary Figure S5: Parameter Sensitivity Analysis
%
% This script reproduces Supplementary Figure S5.
%
% The analysis examines how changes in individual adoption
% parameters affect equilibrium adoption and disparity outcomes.
%
% Parameters explored:
...
data1 = [0.36 0.42 0.45; 
         0.36 0.41 0.43;
         0.36 0.39 0.42]; 

data2 = [0.71 0.65 0.59; 
         0.71 0.67 0.62;
         0.71 0.69 0.65];

data3 = [0.36 0.43 0.49; 
         0.36 0.42 0.45;
         0.36 0.40 0.43];

data4 = [0.71 0.64 0.58; 
         0.71 0.67 0.61;
         0.71 0.68 0.64];

data5 = [0.36 0.46 0.57; 
         0.36 0.43 0.48;
         0.36 0.41 0.45];

data6 = [0.71 0.63 0.54; 
         0.71 0.66 0.60;
         0.71 0.67 0.63];
