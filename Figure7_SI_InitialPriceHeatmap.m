%% Supplementary Figure S7: Initial Price and Benefit Sensitivity Analysis
%
% This script reproduces Supplementary Figure S7.
%
% The analysis examines how innovation price and adoption benefit
% parameters influence equilibrium adoption and disparity outcomes.
%
% Parameters explored:
% - Initial price (rho_0)
% - Adoption benefit (q)
% - Intergroup interaction level (I)
%
% Outputs:
...
b = 0.15; %q
a = 0;
E = 0.202; % the experience parameter E for solar panels
rho0 = 35; 
n = 8000;
...
data1 = [0.175 0.26 0.34; 
         0.165 0.25 0.33;
         0.159 0.24 0.32]; 

data2 = [0.883 0.82 0.74; 
         0.890 0.83 0.75;
         0.9   0.84 0.76];

data3 = [0.177 0.27 0.35; 
         0.167 0.254 0.34;
         0.161 0.245 0.33];

data4 = [0.882 0.815 0.73; 
         0.889 0.825 0.745;
         0.895 0.83 0.755];

data5 = [0.179 0.28 0.36; 
         0.169 0.26 0.35;
         0.163 0.25 0.34];

data6 = [0.881 0.81 0.72; 
         0.888 0.82 0.74;
         0.893 0.825 0.75];
...
titles = {'Disparity for I=0.5', 'Adoption for I=0.5', 'Disparity for I=0.25', ...
          'Adoption for I=0.25', 'Disparity for I=0', 'Adoption for I=0'}; % Titles for each heatmap
