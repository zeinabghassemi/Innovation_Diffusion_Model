%% Figure 2: Impact of Learning Rate on Adoption and Disparity
%
% This script reproduces Figure 2 of the manuscript.
%
% The script evaluates innovation diffusion dynamics under
% different learning rates (E = 0.16, 0.18, 0.20)
...
%
% Outputs:
% - Overall adoption trajectories
% - Transient disparity trajectories
% - Cumulative disparity across learning rates
%
% Author: Zeinab Ghassemi Zahan
...
Dispchcl = [42.2, 40.7, 38.9, 37.0, 34.9, 32.8, 30.6, 28.5, 26.3]; % y-axis values
